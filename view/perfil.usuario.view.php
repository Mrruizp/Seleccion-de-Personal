  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="principal.view.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
                          ...
                          <div class="modal-body">
                                <div class="row">
                                    <div class="col-xs-3">
                                        ...
                                        <input type="text" class="form-control input-sm" name="txtDNI" id="txtDNI" value="<?php echo $resultado["doc_id"];  ?>">
                                    </div>
                                </div>
                            <div class="row">
                                <div class="col-md-6">
