...
//                if(item.estado == 'concluido'){
                    ...
                    html += '<button type="button" class="btn btn-link btn-xs" data-toggle="modal" data-target="#myModal" onclick="resultadosFinal(' + item.codigo_puesto_laboral + ')"><i class="fa fa-user"></i></button>';
                    html += '</td>';
                    html += '</tr>';
//                }    
            });
